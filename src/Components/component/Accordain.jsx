...
const Accordian = () => {
    ...
    <div className="bg-white mt-10  max-w-7xl mx-auto  grid grid-cols-1 lg:grid-cols-3 gap-8 ">
      ...
      <div className="">
        <div className="mb-10 px-4 lg:px-1">
          <p className="text-orange-600 font-medium">| Featured</p>
          <h2 className="font-semibold text-4xl lg:text-5xl text-[#1e1e1e] leading-tight ">
  ...
  className={`p-4 w-full text-left border-b text-lg border-gray-200 font-semibold transition-colors duration-200
              ${openIndex === index ? "bg-orange-100 text-orange-600" : "bg-[#FAFAFA] text-[#1e1e1e]"}`}
>
  {item.question}
</button>
      ...
      <div className="bg-white   shadow-2xl rounded-2xl lg:w-4/5 p-4    ">
        <div className="flex gap-2 lg:gap-8 mt-10 mb-10  border-gray-200">
          <img
          ...
          />
          <div className="">
            <p className=" font-semibold text-[#1e1e1e] lg:text-3xl">250M2</p>
            <p className="text-sm w-30 text-[#AAAAAA]">Total flat surface </p>
          </div>
        </div>
<div className="lg:gap-8">

        <div className="flex  gap-2 lg:gap-8 mt-15">
          <img
            className="w-8 h-8 lg:w-16  lg:h-16"
            ...
            />
          <div className="">
            <p className=" font-semibold  text-[#1e1e1e] lg:text-3xl">Payment </p>
            <p className="text-sm  w-30 text-[#AAAAAA] ">Payment Process </p>
          </div>
        </div>
        <div className="flex   gap-2 lg:gap-8 mt-15">
          <img
          ...
          />
          <div className="">
            <p className=" font-semibold text-[#1e1e1e] lg:text-3xl">Contract</p>
            <p className="text-sm w-30 text-[#AAAAAA] ">Contract Ready </p>
          </div>
        </div>
        <div className="flex  gap-2 lg:gap-8 mt-15">
          <img
            ...
            />
          <div className="">
            <p className=" font-semibold text-[#1e1e1e] lg:text-3xl">Security</p>
            <p className="text-sm w-30 text-[#AAAAAA] ">Security 24/7 </p>
          </div>
            </div>
        </div>
      </div>
